...
* Blazor Server:
  ...
  el programa corre en el servidor, y el navegador solo recibe los cambios. Es rápido al iniciar pero necesita internet todo el tiempo.

* Blazor WebAssembly:

  el código se descarga al navegador y ahí se ejecuta. Puede funcionar incluso sin internet después de cargar.
...
* One-way binding (unidireccional):

la información va en un solo sentido: del código a la vista. Si cambia en el programa, se actualiza en la pantalla, pero no al revés.

* Two-way binding (bidireccional):

la información va y vuelve. Si escribes en un campo de texto, se actualiza la variable en el código; y si cambias la variable desde el programa, se actualiza lo que se muestra en pantalla.
...
13. ¿Cómo se navega entre páginas en una aplicación Blazor?
...
15. ¿Qué es la inyección de dependencias y cómo se usa en Blazor?
...
17. ¿Cómo se consumen servicios o APIs REST desde una aplicación Blazor?
...
19. ¿Qué es @inject y cómo funciona?
...
18. ¿Blazor reemplaza completamente a JavaScript? Justifica tu respuesta.
...
20. ¿En qué tipo de proyecto considerarías que Blazor es una buena opción?
...
22. ¿Qué es MAUI Blazor y cómo se relaciona con Blazor?
...
24. ¿Has creado algún proyecto o ejemplo con Blazor?

Si es así, descríbelo brevemente.
