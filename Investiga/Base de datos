...
Son bases de datos donde la información almacenada se modifica con el tiempo, permitiendo operaciones como actualización, borrado y edición de datos, además de las operaciones fundamentales de consulta. Un ejemplo puede ser la base de datos utilizada en un sistema de información de un supermercado.[3]
...
Además de gestionar el almacenamiento y acceso a los datos, los sistemas de gestores de bases de datos permiten controlar operaciones realizadas de manera simultanea. Para ello utilizan mecanismos de transacción que agrupan varias operaciones relacionadas y permiten que se completen como una unidad. Si una operación no puede finalizar correctamente, el sistema puede evitar que sus cambios parciales queden registrados, lo que ayuda a mantener la coherencia de la información. [4]

Entre los gestores de bases de datos o DBMS más conocidos se encuentran Microsoft SQL Server, MySQL, Oracle Database, Microsoft Access, FileMaker y dBASE.[5]

Diferencias entre bases de datos y hojas de cálculo
Las bases de datos y las hojas de cálculo (por ejemplo las hojas de cálculo de los paquetes de ofimática) son formas convenientes de almacenar información. Las principales diferencias entre ambas son:[6]
...
En las bases de datos relacionales, las claves permiten identificar registros y establece relaciones entre tablas. La clave primaria se utiliza para distinguir de forma única las filas de una tabla, mientras que una clave externa establece una referencia hacia una clave de otra tabla. Estas restricciones permiten mantener la integridad referencial, ya que pueden impedir que una tabla contenga referencias a registros inexistentes en otra tabla. [8]
...
En la actualidad, existen muchos tipos de bases de datos, algunas menos comunes adaptadas a funciones financieras, funciones científicas y otras funciones altamente específicas, todo dependiendo de como va avanzando la tecnología. Entre algunas de ellas se pueden citar:[9]
...
Bases de datos independientes. Las bases de datos independientes, es lo nuevo en base de datos, ( conocidas como bases de datos autónomas), se basan en la nube y utilizan el aprendizaje automático para automatizar el ajuste, la seguridad, las copias de seguridad, las actualizaciones y otras tareas de administración de rutina de las bases de datos que tradicionalmente realizan los administradores de bases de datos.[9]
Bases de datos empresariales. sistema organizado para recopilar, almacenar, gestionar y acceder a información estructurada sobre empresas, sus actividades, productos, servicios o clientes, con el fin de apoyar la toma de decisiones, análisis de mercado y operaciones comerciales.
